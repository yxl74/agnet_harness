    ...
    def _build_prompt(self, task: Task, result: GenerationResult) -> str:
        ...
        if self.structured_output:
            lines += [
                ...
                "   - `scores`: object mapping check/metric names to their measured values.",
                "     For metric checks, use the actual measured value (e.g. {\"pr_auc\": 0.87, \"latency_ms\": 142}).",
                "     For general quality dimensions, use 0.0–1.0 scale.",
